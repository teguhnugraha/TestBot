...
cl.login(token="EmBRLxGX7JZlJipTnPac.dUD2vBQO8g5uyvvnkQgzZa./3qd35Pp5Q/m6uBqaI70TDhIJhi0KEgO8REqVx2OUsQ=") 
cl.loginResult()

ki = LINETCR.LINE() #Zorro
ki.login(token="Em8AoWz7OZVE1bEOfrb2.fZeJxy1Ed1sU1LEI9K9fmG.FmOS2TaCs8lf3Zx0oTUjOTEK6ptDsGdaN3jiqIIXSI4=")
ki.loginResult()

kk = LINETCR.LINE() #Sanji
kk.login(token="EmFBB7gTMf7OmnKoPWrc.qRDaW30QcEGmKdLWKwjvVa.eUDuostOTjNdhVyYNOZ3Qj/zjqkqAgeyWIyXJhD1Efw=")
kk.loginResult()

kc = LINETCR.LINE() #Ussop
kc.login(token="Em4R1zlg8mRof46Cfvw6.tcu3XF4L78rHzIDOL2/VzG.OJOjDbs5+VMCchVv0Q3D9W+I2n0xkEYyf9+5xfw3LZo=") 
kc.loginResult()

ks = LINETCR.LINE() #Chooper
ks.login(token="EmHcCaNOhIn8qqIB2sk5.FY+IlxXfdl6rK9IZRW/4Xq.YH7d4p2yv6vdYUgV6+OM5uCf1GX5opcuu8eCSwDATss=")
ks.loginResult()
...
helpMessage ="""😈Team Sadistic Protect😈
Owner : 🍁✰􁀁􀇢т℮ġuh􏿿✰🍁
■■○○○○○○○○○○○○○■■
◄]·♦·Menu For Public·♦·[►
🍂[•]Adminlist
...
admin=["u2268e71c9e91f04a1f9ee25dbb643dda","ube6c38b3c586f82c479d7f017d9c8e27"] 
owner=["u2268e71c9e91f04a1f9ee25dbb643dda","ube6c38b3c586f82c479d7f017d9c8e27"]
wait = {
    'contact':False,
    'autoJoin':True,
...
☆ TEAM PROLING BOT ☆
☆ FAMS SADISTIC KILLER ☆


Minat? Silahkan PM!
Idline: http://line.me/ti/p/32gpSVjBvB""",
    "lang":"JP",
...
#--------------------------------
    ...
    #-----------------=Selesai=------------------
            ...
            elif msg.text in ["Kuy cancel","Bot cancel"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "||Di Read Oleh||%s\n||By : Sadistic Killer BOT||\n\n>Pelaku CCTV<\n%s-=CCTV=-\n•Bintitan\n•Panuan\n•Kurapan\n•Kudisan\n\nAmiin Ya Allah\n[%s]" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                        cl.sendText(msg.to, "Ketik Cctv dulu Bos\nBaru Ketik Ciduk\nDASAR PIKUN ♪")
#-----------------------------------------------

#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Kuy","Join kuy"]: #Panggil Semua Bot
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Bye kuy","Kabur all","Bye all"]: #Bot Ninggalin Group termasuk Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
            ...
            elif msg.text in ["Go home"]: #Semua Bot Ninggalin Group Kecuali Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
    ...
    #-------------Fungsi Tag All Start---------------#
            elif msg.text in ["Desah yuk", "Tag all","Tagall"]:
            	 if msg.from_ in admin:
    ...
    #-------------Fungsi Tag All Finish---------------#
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if matched_list == []:
                        ...
                        random.choice(KAC).sendText(msg.to,"Jangan masuk lagi􀨁􀆷 devil smile􏿿")
                        return
        ...
        #-------------Fungsi Spam Start---------------------#
            elif msg.text in ["Up","Spam","Up Chat","Up chat","up chat","Upchat","upchat"]:
              if msg.from_ in admin:
      ...
      #--------------Fungsi Broadcast Finish-----------#
            ...
            elif msg.text in ["List group"]: #Melihat List Group
              if msg.from_ in admin:
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
            elif msg.text in ["Bot out","Sk out"]: # Keluar Dari Semua Group Yang Di dalem nya  ada bot(Kalo Bot Kalian Nyangkut di Group lain :D)
              if msg.from_ in owner:
                gid = cl.getGroupIdsJoined()
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to,"Tukang Colmex On")
                ki.sendText(msg.to,"Tukang Colli On")
                kk.sendText(msg.to,"Tukang Tikung On")
                kc.sendText(msg.to,"Tukang Desah On")
                ks.sendText(msg.to,"Tukang Bacot On")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              msg.contentType = 13
              msg.contentMetadata = {'mid': 'u2268e71c9e91f04a1f9ee25dbb643dda'}
              cl.sendText(msg.to,"======================")
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
    ...
    for zx in range(0,500):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by 🍁Team Sadistic🍁\n\nAdd http://line.me/ti/p/32gpSVjBvB")
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto like by ^Team Sadistic ^\nStatus Boss udah Kami Like\nOwner Kami :\nhttp://line.me/ti/p/32gpSVjBvB")
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"=====Ready=====\n[★]Bot Protect For Group\n[★]\n[★]Selfbot in Your Account[★]\n- 1 Selfbot 1 Bot Assist\n- 1 Selfbot 2 Bot Assist\n- 1 Selfbot 3 Bot Assist\n- 1 Selfbot 4 Bot Assist\n- 1 Selfbot 5 Bot Assist\n\nMinat??? PM Id http://line.me/ti/p/32gpSVjBvB\n\n===[★]Team Sadis Bot Protect[★]===")
                    print "Like"
                except:
                    pass
            else:
